...
public class pantalla_fibooTe {
    ...
    public void pantalla_fibooTe() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.valor_fibo),
                        childAtPosition(
                                allOf(withId(R.id.pant_fibo),
                                        childAtPosition(
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.boton_fibo), withText("Ingresar"),
                        childAtPosition(
                                allOf(withId(R.id.accion_boton_fibo),
                                        childAtPosition(
                                                withId(R.id.pant_fibo),
                                                2)),
                                0),
                        isDisplayed()));
